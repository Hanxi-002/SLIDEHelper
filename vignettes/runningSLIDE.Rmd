...
SLIDE_res <- SLIDEHelper::GetTopFeatures(x_path = SSc_data$x, y_path = SSc_data$y, er_path = SSc_data$er_results, out_path = ".", SLIDE_res = SSc_data$SLIDE_res$SLIDE_res, num_top_feats = num_top_feats, condition)
